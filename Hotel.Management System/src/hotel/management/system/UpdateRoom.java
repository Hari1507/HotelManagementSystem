...
public class UpdateRoom extends JFrame implements ActionListener {
    ...
    Choice customer;
    JTextField tfroom, tfavalable, tfstatus, tfpaid, tfpending;
    ...
    UpdateRoom() {
       ...
       tfavalable = new JTextField();
       tfavalable.setBounds(200, 180, 150, 25);
       add(tfavalable);
    ...
    public void actionPerformed(ActionEvent ae) {
       if (ae.getSource() == check) {
           ...
           try {
               ...
               while(rs2.next()) {
                  tfavalable.setText(rs2.getString("availability"));
         ...
         String available = tfavalable.getText();
